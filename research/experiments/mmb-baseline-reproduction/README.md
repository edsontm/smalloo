...
- Slug: `mmb-baseline-reproduction`
- Created: `2026-07-31`
- Status: Planning
...
1. Validate the devsample layout with `python3 scripts/validate_experiment.py --slug mmb-baseline-reproduction --dataset-profile devsample`.
2. Generate deterministic per-seed manifests with `python3 scripts/materialize_runs.py --slug mmb-baseline-reproduction --dataset-profile devsample`.
